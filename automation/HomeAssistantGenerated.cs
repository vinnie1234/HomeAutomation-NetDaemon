...
//   At: 2026-09-02T14:46:39.9869141+02:00
//
...
public partial class SensorEntities
{
    ...
    ///<summary>P1 meter (3c39e72a64e8) Energie import Cost</summary>
...
public partial class UpdateEntities
{
    ...
    public UpdateEntity BlueprintsUpdateNotifications => new(_haContext, "update.blueprints_update_notifications");
...
public partial class GamingStatusServices
{
    ...
    ///<summary>Manually insert a completed session into a player&apos;s history (e.g. to backfill play that was never tracked), correcting daily/weekly/lifetime totals the same way an organically-tracked session would.</summary>
    ///<param name="player"> eg: Adam</param>
    ...
    ///<summary>Move one specific recorded session from one player&apos;s history to another (optionally onto a different platform), correcting daily/weekly/lifetime totals on both ends. Useful when a session was tracked under the wrong person&apos;s profile (e.g. the wrong account signed into a shared app/console).</summary>
    ///<param name="fromPlayer">The player the session is currently attributed to. eg: Adam</param>
    ...
    ///<param name="toPlayer">The player this session should be attributed to instead. eg: Josh</param>
...
{
    ///<summary>The player the session is currently attributed to. eg: Adam</summary>
    ...
    ///<summary>The player this session should be attributed to instead. eg: Josh</summary>
